...
--
-- Host: localhost
-- Generation Time: Dec 04, 2017 at 02:02 PM
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=latin1 COMMENT='Category classifications of inventory items';
...
--
ALTER TABLE `reviews`
 ADD PRIMARY KEY (`reviewId`), ADD KEY `invId` (`invId`,`clientId`), ADD KEY `clientId` (`clientId`);
